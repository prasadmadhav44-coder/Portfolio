...
import { certificationsFallback } from '../data/certificationsData';

function Certifications() {
  const { data: certifications } = usePublicTable('certifications', { fallbackData: certificationsFallback });
