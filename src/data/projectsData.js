// `live`/`github` are only shown as buttons when non-empty, so nothing
// links to a broken URL. Ecommerce Store and the AI Finance Analyst are
// filled in below. Wireless Patient Alert System is still blank — add its
// repo/demo link (if any) the same way once you have one.
export const projectsData = [
  {
    id: 'ecommerce-store',
    title: 'Ecommerce Store',
    live: 'https://ecommerce-store-blond-rho.vercel.app/',
    github: 'https://github.com/prasadmadhav44-coder/Ecommerce-Store',
    status: 'Completed',
    shortDescription:
  ...
  },
  {
    ...
    live: 'https://ai-finance-analyst-bvir.onrender.com/',
    github: 'https://github.com/prasadmadhav44-coder/AI-Finance-Analyst',
    status: 'Completed',
    shortDescription:
